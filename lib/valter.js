    ...
    if (contract || data) {
        for (var key in contract) {
            ...
            if (typeof contract[key] != typeof data[key]) {
                console.log("ERROR: Contract expects that your service data contains '" + key + "' property, but could not find or types does not match! ");
...
exports.assertContracts = function(contractPaths, done){
